...
public class PostAPIController {
  ...
  public ResponseEntity<PostDto> createPost(
    ...
    // dto에서 엔티티로 변환
    Post createdPost =
        postService.createPost(post, imageFiles, categoryNames, post_type_id, thumbs, httpSession);
  ...
  public ResponseEntity<List<PostListDto>> getPostSummaries(
      @PathVariable("post_type_id") Long post_type_id) {
  ...
  public ResponseEntity<PostDto> getPost(
      @PathVariable("post_type_id") Long post_type_id, @PathVariable("postId") Long postId) {
  ...
  public boolean likePost(
      @PathVariable("postId") Long postId, @RequestParam("userId") String userId) {
  ...
  public ResponseEntity<PostDto> updatePost(
    ...
    //  public ResponseEntity<PostDto> updatePost(@PathVariable("post_type_id") Long postTypeId,
    // @PathVariable("postId") Long postId, @RequestParam("userId") String userId, @RequestBody
    // PostDto postDto){
    String userId = (String) session.getAttribute("userId");
    return postService
        .updatePost(postId, postDto, userId)
